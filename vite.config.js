...
export default defineConfig({
  ...
  build: {
    ...
    assetsDir: 'assets',
    rollupOptions: {
      // Pages is the product artifact. The Sumer page is intentionally a
      // separate experimental surface powered by the extracted reality kernel,
      // so the living-planet root remains unchanged.
      input: {
